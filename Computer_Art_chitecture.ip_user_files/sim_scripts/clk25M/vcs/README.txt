...
#
# Generated by export_simulation on Wed May 23 17:32:24 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './clk25M.sh' script.
...
./clk25M.sh -noclean_files

For more information on the script, please type './clk25M.sh -help'.
