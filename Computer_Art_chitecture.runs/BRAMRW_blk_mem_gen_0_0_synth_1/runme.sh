...
HD_PWD='C:/Users/Giuliano/Desktop/BRAMtoVGA/BRAMtoVGA.runs/BRAMRW_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAMRW_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRAMRW_blk_mem_gen_0_0.tcl
